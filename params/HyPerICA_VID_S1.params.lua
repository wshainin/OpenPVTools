...
local nxSize              = 256/2 -- (1280/4)*4/5
local nySize              = 144/2 -- (720/4)*4/5
local experimentName      = "ImageNetVid_2015_vehicles_S1X" .. overcompleteness .. "_" .. patchSizeX .. "X" .. patchSizeY .. "_" .. temporalKernelSize .. "X" .. numFrames .. "frames"
local experimentNameTmp   = "ImageNetVid_S1X" .. overcompleteness .. "_" .. patchSizeX .. "X" .. patchSizeY .. "_" .. temporalKernelSize .. "X" .. numFrames .. "frames"
local runName             = "train" 
local runVersion          = 1
local runVersionTmp       = 6
local machinePath         = "/home/gkenyon" -- "/home/ec2-user/mountData" --"/Volumes/mountData" --
...
local inputPathSLP        = nil --machinePath .. "/" .. databasePath .. "/" .. experimentName .. "/" .. runName .. runVersion
local numImages           = 208546 --10036 --8211--
local displayPeriod       = 900 --1200
local numEpochs           = 1
local stopTime            = numImages * displayPeriod * numEpochs
local checkpointID        = "2268000" --stopTime-- 
...
--i/o parameters
local imageListPath       = machinePath .. "/" .. "imageNet/vid2015/imageNetVID_2015_list.txt" 
--local GroundTruthPath     = machinePath .. "/" .. "imageNet/vid2015/imageNetVID_2015.pvp" 
local startFrame          = 0
...
local dtScaleMax               = 0.11   --1.0     -- minimum value for the maximum time scale, regardless of tau_eff
local dtScaleMin               = 0.1  --0.01    -- default time scale to use after image flips or when something is wacky
local dtChangeMax              = 0.02   --0.1     -- determines fraction of tau_effective to which to set the time step, can be a small percentage as tau_eff can be huge
local dtChangeMin              = 0.02  --0.01    -- percentage increase in the maximum allowed time scale whenever the time scale equals the current maximum
