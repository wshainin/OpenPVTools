...
local patchSize        = 8;
local stride           = 4
local displayPeriod    = 40000;   --Number of timesteps to find sparse approximation
...
local writeStep        = 400; --displayPeriod; 
local initialWriteTime = 399; --displayPeriod; 

local runType          = "cifarControlStrideFourHardThreshActivityReset_Perturbation_TEST";
local runVersion       = 3;
