package.path = package.path .. ";" .. "/Users/wshainin/workspace/OpenPV/parameterWrapper/?.lua";
...
local writeStep        = displayPeriod/2; 
local initialWriteTime = displayPeriod/2; 

local runType          = "cifarControlStrideFourHardThreshActivityReset";
local runVersion       = 2;
local workspacePath    = "/home/wshainin/workspace/";
local inputPath        = workspacePath .. "cifar-10-batches-mat/cifar_mixed_test.txt";
local outputPath       = workspacePath .. "sandbox/" .. runType .. "_" .. runVersion;
local groundTruthPath  = "";
...
local pvParameters = {
   ...
   S1 = {
      ...
      updateGpu                           = false; --true; --TODO TODO TODO TODO TODO TODO
      dataType                            = nil;
      VThresh                             = VThresh;
      AMin                                = AMin;
      AMax                                = AMax;
