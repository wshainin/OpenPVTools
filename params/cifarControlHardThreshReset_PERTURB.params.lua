...
local patchSize        = 8;
local stride           = 4
local displayPeriod    = 1600;   --Number of timesteps to find sparse approximation
...
local runType          = "cifarControlStrideFourHardThreshActivityReset_OnePerturbation";
local runVersion       = 1;
local workspacePath    = "/home/wshainin/workspace/";
local inputPath        = workspacePath .. "cifar-10-batches-mat/cifar_mixed_batch.txt";
