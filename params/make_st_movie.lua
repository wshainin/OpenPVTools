...
local checkpointID                 = "1278000" --stopTime-- 
local checkpointID_SLP             = "1278000" --stopTime--
...
local GroundTruthPath              = machinePath .. "/" .. databasePath .. "/" .. "imageNetVID_128x72_landscape.pvp" 
local saveGT                       = true
local startFrame                   = 0
...
if S1_Movie then
    ...
    if GroundTruthPath  or saveGT then
